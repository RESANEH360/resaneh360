...
use ThePackThemeBuilder\Modules\ThemeBuilder\Documents;
...
class Templates_Types_Manager
{
    ...
    public function get_types_config($args = [])
    {
        ...
        $document_types = thepack_builder()->elementor()->documents->get_document_types($args);
    ...
    public function register_documents()
    {
        ...
        foreach ($this->docs_types as $type => $class_name) {
            thepack_builder()->elementor()->documents->register_document_type($type, $class_name);
        }
    }
}
