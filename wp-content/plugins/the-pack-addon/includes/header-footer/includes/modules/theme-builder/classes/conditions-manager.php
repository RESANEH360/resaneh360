...
use ThePackThemeBuilder\Modules\ThemeBuilder\Conditions\Condition_Base;
...
class Conditions_Manager
{
    ...
    public function admin_columns_headers($posts_columns)
    {
        ...
        $posts_columns = array_slice($posts_columns, 0, $offset, true) + [
            'instances' => __('Instances', 'thepack'),
    ...
    public function ajax_check_conditions_conflicts($request)
    {
        ...
        return __('Elementor recognized that you have set this location for other templates: ', 'thepack') .
            ' ' .
            implode(', ', $conflicted);
    }
    ...
    {
        /** @var \ThePackThemeBuilder\Modules\ThemeBuilder\Module $theme_builder_module */
        $theme_builder_module = Module::instance();
    ...
    private function register_condition($id, $args = [])
    {
        ...
        $class_name = '\\ThePackThemeBuilder\\Modules\\ThemeBuilder\\Conditions\\' . $class_name;
