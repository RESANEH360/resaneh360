...
class Preview_Manager
{
    ...
    {
        $document = thepack_builder()->elementor()->documents->get_doc_or_auto_save(get_the_ID());
    ...
    {
        $current_post_id = get_the_ID();
        $document = thepack_builder()->elementor()->documents->get_doc_or_auto_save($current_post_id);
        ...
        thepack_builder()->elementor()->db->switch_to_query($new_query_vars, true);
    ...
    {
        thepack_builder()->elementor()->db->restore_current_query();
    }
}
