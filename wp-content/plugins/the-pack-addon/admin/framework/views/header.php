...
<div class="csf-welcome csf-welcome-wrap">
    ...
    <p class="csf-demo-button"><a href="<?php echo esc_url(add_query_arg(['csf-demo' => $status])); ?>"
                                  class="button button-primary<?php echo esc_attr($class); ?>"><?php echo esc_attr($text); ?>
            Demo</a></p>
    ...
    <h2 class="nav-tab-wrapper wp-clearfix">
        ...
        foreach ($links as $key => $link) {
            ...
            echo '<a href="' . esc_url(add_query_arg(['page' => 'csf-welcome',
                'section' => $key
