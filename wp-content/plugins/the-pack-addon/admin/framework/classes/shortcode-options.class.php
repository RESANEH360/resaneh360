    ...
    class CSF_Shortcoder extends CSF_Abstract
    {
        ...
        public function __construct($key, $params = [])
        {
            ...
            if (!empty($this->args['show_in_editor'])) {
                CSF::$shortcode_instances[$this->unique] = wp_parse_args([
                    'hash' => md5($key),
                ...
                if (CSF::is_active_plugin('elementor/elementor.php')) {
                    ...
                    add_action('elementor/editor/footer', ['CSF_Field_icon', 'add_footer_modal_icon']);
        ...
        public function add_footer_modal_shortcode()
        {
            ...
            echo '</div>'; ?>
                            ...
                            <div class="csf-modal-insert-wrapper hidden"><a href="#"
                                                                            class="button button-primary csf-modal-insert"><?php echo $this->args['insert_title']; ?></a>
                            </div>
                        </div>
                    </div>
                </div>
