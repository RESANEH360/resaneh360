    ...
    class CSF_Field_typography extends CSF_Fields
    {
        ...
        public function enqueue()
        {
            if (!wp_script_is('csf-webfontloader')) {
                ...
                wp_enqueue_script('csf-webfontloader', 'https://cdn.jsdelivr.net/npm/webfontloader@1.6.28/webfontloader.min.js', ['csf'], '1.6.28', true);
                ...
                $defaultstyles = apply_filters('csf_field_typography_defaultstyles', [
                    'normal',
                    'italic',
                    '700',
                    '700italic'
        ...
        public function enqueue_google_fonts($method = 'enqueue')
        {
            ...
            if ($is_google) {
                ...
                if ($font_weight || $font_style) {
                    ...
                    CSF::$webfonts[$method][$font_family] = [];
                }
