    ...
    class CSF_Field_code_editor extends CSF_Fields
    {
        ...
        public function enqueue()
        {
            ...
            if (!wp_script_is('csf-codemirror')) {
                wp_enqueue_script('csf-codemirror', esc_url($this->cdn_url . $this->version . '/lib/codemirror.min.js'), ['csf'], $this->version, true);
                wp_enqueue_script('csf-codemirror-loadmode', esc_url($this->cdn_url . $this->version . '/addon/mode/loadmode.min.js'), ['csf-codemirror'], $this->version, true);
            }

            if (!wp_style_is('csf-codemirror')) {
                wp_enqueue_style('csf-codemirror', esc_url($this->cdn_url . $this->version . '/lib/codemirror.min.css'), [], $this->version);
            }
        }
    }
}
