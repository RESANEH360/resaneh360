...
<div class="csf-welcome-cols">
    ...
    <div class="csf--col csf--col-first">
        ...
        <p class="csf--text">Built in Object Oriented Programming paradigm with high number of custom fields and tons of
            options. It's highly modern and advanced framework.</p>
    </div>

    <div class="csf--col csf--col-first">
        <span class="csf--icon csf--<?php echo esc_attr(CSF::$premium ? 'active' : 'deactive'); ?>"><i
                    class="fas fa-<?php echo esc_attr(CSF::$premium ? 'check' : 'times'); ?>"></i></span>
        <div class="csf--title">Customize Option Framework</div>
        <p class="csf--text">Inherits the default WordPress Customizer with integration of own custom fields. It's more
            powerful to customize your site on live.</p>
    </div>
    ...
    <div class="csf--col csf--col-first csf--last">
        ...
        <p class="csf--text">Allows you to bring custom metabox settings to all of your pages and posts. We provide
    ...
    <div class="csf--col csf--col-first">
        ...
        <p class="csf--text">Allows you to bring custom nav menu item settings to all of your menus. We provide advanced
    ...
    <div class="csf--col csf--col-first">
        ...
        <p class="csf--text">Allows you to bring custom taxonomy settings to all of your categories, tags or CPT. We
    ...
    <div class="csf--col csf--col-first csf--last">
        ...
        <p class="csf--text">Allows you to bring custom user profile settings to all of users. We provide advanced
            settings with numerious number of fields.</p>
    </div>
    ...
    <div class="csf--col">
        ...
        <p class="csf--text">Allows you to creating custom widgets. We provide advanced settings wtih numerious number
            of fields.</p>
    </div>
    ...
    <div class="csf--col">
        ...
        <p class="csf--text">Allows you to bring custom comment metabox settings to all of comments. We provide advanced
            settings wtih numerious number of fields.</p>
    </div>
    ...
    <div class="csf--col csf--last">
        ...
        <p class="csf--text">Comes with pre-built shortcode editor to manage your content. It's easy and flexible to
