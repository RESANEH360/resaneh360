...
if (!class_exists('CSF_Field_icon')) {
    class CSF_Field_icon extends CSF_Fields
    {
        ...
        {
            add_action('admin_footer', [&$this, 'add_footer_modal_icon']);
            add_action('customize_controls_print_footer_scripts', [&$this, 'add_footer_modal_icon']);
        }
                    ...
                    <div class="csf-modal-table-cell">
                        ...
                        <div class="csf-modal-inner">
                            ...
                            <div class="csf-modal-header">
                                <input type="text" placeholder="<?php esc_html_e('Search...', 'csf'); ?>"
                                       class="csf-icon-search"/>
                            </div>
